        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {/* Content */}
                <div className="px-6 py-8">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">Dịch vụ vận chuyển các loại hàng khó đi đến các quốc gia trên thế giới?</p>

                    <p className="text-gray-700 leading-relaxed mb-6">Xử lý hàng hóa theo đúng tiêu chuẩn quy định của hãng bay và yêu cầu đầu vào của các nước nhập.</p>

                    {/* FDA Section */}
                    <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-6">
                        <p className="text-gray-900 font-bold text-lg mb-4">Đăng ký FDA bắt buộc hoàn toàn miễn phí.</p>
                        <div className="mb-4">
                    ...
                    <div className="bg-green-50 border-l-4 border-green-400 p-6 mb-6">
                        <p className="text-gray-900 font-bold text-lg mb-4">Đăng ký MSDS bắt buộc hoàn toàn miễn phí.</p>
                    ...
                    <div className="bg-gradient-to-r from-[#ff5722] to-[#e64a19] text-white rounded-lg p-6 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="tel:19006750" className="bg-white text-[#ff5722] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                                Gọi ngay: 1900 6750
                            </a>
                            <a href="/lien-he" className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-[#ff5722] transition-colors">
                                Liên hệ trực tuyến
                            </a>
                        </div>
                    </div>

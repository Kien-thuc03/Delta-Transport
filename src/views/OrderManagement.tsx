...
import { faCheck, faExclamationTriangle, faInfoCircle, faShoppingCart, faExchangeAlt, faMoneyBillWave } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm">
            <div className="prose max-w-none">
              ...
              <div className="space-y-12 mt-10">
                ...
                <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-[#ff5722]">
                  <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#ff5722] text-white text-sm">1</span>
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#ff5722] text-white text-sm">2</span>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="list-none space-y-3 mt-4">
                      <li className="flex gap-3">
                        ...
                        <div>
                          <p className="font-medium">Sử dụng công cụ dịch</p>
                      ...
                      <li className="flex gap-3">
                        <FontAwesomeIcon icon={faCheck} className="text-[#ff5722] mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium">Tìm theo hình ảnh</p>
                      ...
                      <li className="flex gap-3">
                        <FontAwesomeIcon icon={faCheck} className="text-[#ff5722] mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium">Dùng các công cụ hỗ trợ</p>
                      ...
                      <li className="flex gap-3">
                        <FontAwesomeIcon icon={faCheck} className="text-[#ff5722] mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium">Tìm sản phẩm có nhiều đánh giá</p>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400 mt-6 flex gap-3">
                      ...
                      <div>
                        <p className="font-medium">Lưu ý khi tìm kiếm</p>
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#ff5722] text-white text-sm">3</span>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mt-6">
                      <div className="relative">
                        <div className="border border-gray-200 p-4 rounded-lg bg-white h-full">
                          <div className="flex justify-center mb-3">
                            <FontAwesomeIcon icon={faShoppingCart} className="text-[#ff5722] text-3xl" />
                          </div>
                          <h3 className="font-bold text-center mb-2">Bước 1: Gửi yêu cầu</h3>
                          <p className="text-sm text-gray-600">
                            Gửi link sản phẩm và các thông tin như màu sắc, kích cỡ, số lượng đến Delta Transport.
                          </p>
                        </div>
                        <div className="hidden md:block absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 w-4 h-4 rotate-45 border-t border-r border-gray-200 bg-white"></div>
                      </div>
                      ...
                      <div className="relative">
                        <div className="border border-gray-200 p-4 rounded-lg bg-white h-full">
                          ...
                          <h3 className="font-bold text-center mb-2">Bước 2: Thanh toán</h3>
                          <p className="text-sm text-gray-600">
                      ...
                      <div>
                        <div className="border border-gray-200 p-4 rounded-lg bg-white h-full">
                          ...
                          <h3 className="font-bold text-center mb-2">Bước 3: Nhận hàng</h3>
                          <p className="text-sm text-gray-600">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400 mt-6 flex gap-3">
                      ...
                      <div>
                        <p className="font-medium">Thời gian vận chuyển</p>
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#ff5722] text-white text-sm">4</span>
                    Lưu ý quan trọng khi đặt hàng
                  </h2>
                  
                  <div className="space-y-5 mt-4">
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#ff5722] text-white font-medium text-sm">1</div>
                      <div>
                        <p className="font-medium">Chọn shop uy tín</p>
                    ...
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#ff5722] text-white font-medium text-sm">2</div>
                      <div>
                        <p className="font-medium">Kiểm tra kỹ thông tin sản phẩm</p>
                        <p className="text-gray-600 text-sm">Đặc biệt là kích thước, chất liệu và hình ảnh thực tế từ khách hàng đã mua.</p>
                      </div>
                    </div>
                    
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#ff5722] text-white font-medium text-sm">3</div>
                      <div>
                        <p className="font-medium">Tính toán chi phí tổng</p>
                    ...
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#ff5722] text-white font-medium text-sm">4</div>
                      <div>
                        <p className="font-medium">Chú ý thời điểm mua hàng</p>
              ...
              <div className="mt-12 bg-gray-50 p-6 rounded-lg">
                ...
                <div className="flex gap-4 mt-6">
                  <button className="bg-[#ff5722] hover:bg-[#e64a19] text-white font-medium px-6 py-3 rounded transition-colors">
                    Tư vấn miễn phí
                  </button>
                  <button className="bg-white hover:bg-gray-100 text-gray-800 font-medium px-6 py-3 rounded border border-gray-300 transition-colors">
                    Đặt hàng ngay
                  </button>
                </div>
              </div>
